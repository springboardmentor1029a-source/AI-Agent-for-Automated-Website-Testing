...
def home():
    ...
    <ul>
        ...
        <li>GET /screenshots/&lt;filename&gt; - Serve screenshots</li>
    </ul>
...
def run_test():
    try:
        ...
        # Format screenshot paths for the GUI
        screenshots = final_state.get("screenshots", [])
        screenshot_urls = []
        for screenshot in screenshots:
            if isinstance(screenshot, str):
                filename = os.path.basename(screenshot)
                screenshot_urls.append(f'/screenshots/{filename}')
...
def serve_screenshot(filename):
    """Serve screenshot files from outputs/screenshots directory"""
    screenshots_dir = os.path.join(current_dir, 'outputs', 'screenshots')
